...
export const badgeVariants = cva("inline-flex items-center gap-1 rounded-full border px-2.5 py-1 text-caption font-bold tracking-[.02em]", { variants: { variant: {
  default: "border-primary/20 bg-primary-subtle text-primary-subtle-foreground",
  neutral: "border-border/12 bg-surface-muted/75 text-muted-foreground",
