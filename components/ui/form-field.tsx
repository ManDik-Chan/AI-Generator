...
const control = "w-full rounded-control border border-border-strong/18 bg-surface-raised text-sm text-foreground shadow-[0_1px_0_hsl(var(--overlay)/.03)] outline-none transition-[border-color,box-shadow,background-color] duration-fast placeholder:text-muted-foreground/75 hover:border-border-strong/32 focus:border-primary focus:ring-2 focus:ring-focus-ring/15 disabled:cursor-not-allowed disabled:bg-surface-muted disabled:opacity-65 aria-[invalid=true]:border-destructive aria-[invalid=true]:ring-2 aria-[invalid=true]:ring-destructive/15";
