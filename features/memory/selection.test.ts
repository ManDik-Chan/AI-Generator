...
const memory = (id: string, content: string, extra: Partial<Parameters<typeof selectRelevantMemories>[0]["candidates"][number]> = {}) => ({ id, content, category: "other", scope: "GLOBAL" as const, verificationMethod: "MANUAL_ENTRY" as const, importance: 3, enabled: true, updatedAt: "2026-07-13T00:00:00Z", ...extra });
